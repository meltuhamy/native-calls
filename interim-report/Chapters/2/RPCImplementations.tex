...
% Apache Thrift is another RPC system designed and open-sourced by Facebook in the Apache project. It provides a way to implement scalable, cross-language services \cite{thrift}.


\subsection{WebIDL}
WebIDL is a specification \cite{webidlw3c} for an interface definition language that can be used by web browsers. It is used in several projects, including Google Chrome's Blink project\footnote{http://www.chromium.org/blink/webidl}.
